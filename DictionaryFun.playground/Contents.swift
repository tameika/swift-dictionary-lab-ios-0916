 ...
 */
var someStates = ["New York": "Albany", "Ohio": "Columbus", "Florida": "Tallahassee", "Georgia": "Atlanta", "Kentucky": "Frankfort"]
 ...
 */
// Optional string keys to optional string values dictionary
 ...
 */
if let capital = someStates["Florida"] {
 ...
 */
var anotherCapital = someStates["Harrisburg"]
...
if let anotherCapital = someStates["Harrisburg"] {
...
if let newCapital = someStates["Pennsylvania"] {
    
    print("Pennsylvania's capital is \(newCapital)")
}
...
print("The capital of \(state) is \(someStates[state])")
...
// Optional string keys to array values dictionary
